...
function Textarea({ className, ...props }: React.ComponentProps<"textarea">) {
  return (
    <textarea
      data-slot="textarea"
      className={cn(
        "flex min-h-20 w-full rounded-[var(--r-md)] border border-border bg-surface px-3.5 py-2.5 text-sm text-text shadow-[var(--shadow-sm)] transition-colors duration-150",
